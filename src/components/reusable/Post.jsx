    ...
    <section className="flex flex-col gap-4">
      <article className="bg-white p-4 rounded-lg grid grid-cols-1 grid-rows-[repeat(3,min-content)] gap-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="cursor-pointer flex items-center gap-2 preset-2-m text-purple-600">
      ...
      {replay && (
        <div className="pl-4 flex flex-col gap-4 border-l-2 border-grey-100">
          {replay.map((replies, idx) => (
            <div key={idx} className="bg-white p-4 rounded-lg grid grid-cols-1 grid-rows-[repeat(3,min-content)] gap-y-4">
              <div className="flex items-center gap-4">
                <img
                  className="size-8"
                  src={replies.avatar}
              ...
              <div className="flex items-center justify-between">
                ...
                {replies.user === "juliusomo" ? (
                  <div className="preset-2-m flex items-center gap-4">
                    <button className="cursor-pointer flex items-center gap-2 text-pink-400">
                      {deleteIcon}
                      <span>Delete</span>
                    </button>
                    <button className="cursor-pointer flex items-center gap-2 text-purple-600">
                      {editIcon}
                      <span>Edit</span>
                    </button>
                  </div>
